...
//Route::get('single-service/{id}','GetCars@index');
...
Route::get('/all-blogs','AllBlog@index');
Route::get('/all-blogs/{category_id}','AllBlogsCategory@index');
Route::post('/all-blogs/search','BlogSearch@index')->name('blogserch');
Route::get('/single-blog/{id}','SingleBlog@index');
//Route::get('/single-service/{id}-{slug}','SingleService@index');
Route::get('/single-service/{id}-{slug}','SingleService@index');
Route::get('/all-service','AllServices@index');
Route::get('/all-projects','AllProjects@index');
Route::get('/all-projects/{id}','AllProjectsCategories@index');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::resource('/dproject','ProjectAkwanController');
    Route::resource('/dcategory','CategoryController');
    Route::resource('/dskills','SingleAboutController');
    Route::resource('/dchallenge','SingleAboutChallengeController');
    Route::resource('/dblogcategory','BlogCategoryController');
    Route::resource('/dblogarticle','BlogArticleController');
    Route::resource('/dnewservices' ,'NewServicesController');
    Route::resource('/dsubservice','SubServiceController');

    Route::resource('/dblogimage','BlogImagesControllerController');
    Route::resource('/dcreativeservices' ,'NewCreativeServicesController');
      Route::post('/duploadImage' ,'fetchupload@store');
