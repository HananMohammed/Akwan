...
{{--            <label for="company_name">{{trans('form.company_name')}}</label>--}}
            ...
            <input type="text" name="type" value="finance" class="form-control" placeholder="type" hidden>
            ...
            <textarea  name="text" class="form-control" placeholder="text" required rows="5"></textarea>
            ...
            <div class="col-sm-12 mt-4 ">
                <div class="row justify-content-between align-items-center select-gutter">
                    ...
                    <div class="col-md-6 col-sm-12 mb-4">
                        <input type="text" name="years_of_experience" class="form-control" placeholder="years_of_experience" >
                    </div>
                    <div class="col-md-6 col-sm-12 mb-4">
                    ...
                    <div class="col-md-6 col-sm-12 mb-4">
                        <input type="text" name="monthly_salary" class="form-control" placeholder="monthly_salary" >
                    </div>
                    <div class="col-md-6 col-sm-12 mb-4">
                        <input type="number" name="select_monthly_obligations" id="select_monthly_obligations" class="form-control" min="20000" value="" placeholder="حد ادنى 20,000 ريال">
                    </div>
                    <div class="col-md-6 col-sm-12 mb-4">
                        <input type="text" name="total_monthly_obligations" class="form-control" placeholder="total_monthly_obligations" >
                    </div>
                </div>
            </div>
