...
{{--                                @method('put')--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text"    name="gooles_en" id="gooles_en" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="gooles_ar">{{trans('mission.gooles_ar')}}</label>
                                    <textarea type="text"    name="gooles_ar" id="gooles_ar" class="form-control"></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="target_en">{{trans('mission.target_en')}}</label>
                                    <textarea type="text"    name="target_en" id="target_en" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="target_ar">{{trans('mission.target_ar')}}</label>
                                    <textarea type="text"    name="target_ar" id="target_ar" class="form-control"></textarea>
                                </div>
                                <br>
