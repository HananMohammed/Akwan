    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card-body">
                        <h5 class="card-title">{{trans('newservices.editcreativeservice')}}</h5>
                        <div class="main-card p-5 card">

                            <form method="post" action="{{ route('dcreativeservices.update',[$data->id]) }}" enctype="multipart/form-data" >
                                @csrf
                                 @method('put')
