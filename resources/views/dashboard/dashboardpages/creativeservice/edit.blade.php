    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card-body">
                        <h5 class="card-title">{{trans('newservices.addcreativeservice')}}</h5>
                        <div class="main-card p-5 card">



                            <form method="post" action="{{ route('dcreativeservices.store') }}" enctype="multipart/form-data" >
                                @csrf
                                ...
                                <br>
                                <button class="btn btn-success" type="submit">{{trans('newservices.addcreativeservice')}}</button>
