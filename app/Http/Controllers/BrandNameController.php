...
class BrandNameController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy($id , BrandName $brandModel ,CrudRepository $crud)
    {

       // $data=$crud->checkBeForeDelete($id,$brandModel);


         $msg = 'Can\'t Delete this item as it contains ' ;
        // return redirect()->route('dbrand.index',compact('data',$data ))->with('massege' ,$msg);
      return redirect()->back()->with('data' , $crud->checkBeForeDelete($id,$brandModel));
