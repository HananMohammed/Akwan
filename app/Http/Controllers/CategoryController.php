...
class CategoryController extends Controller
{
    ...
    public function index(CrudRepository $crud ,Category $catModel)
    {
         ...
         return view('dashboard.dashboardpages.category.index',compact('data'));
    }
    ...
    {
        return view('dashboard.dashboardpages.category.edit');
    ...
    public function edit( $id, CrudRepository $crud ,Category $modelname)
    {
        ...
        return view('dashboard.dashboardpages.category.update',compact('data'));
    }
